    ...
    <Grid container className="homepage">
      <Grid container className="homepage__container">
        <Grid container className="homepage__landing">
          <Grid item xs={12} sm={6} className="homepage__landing--text">
          ...
          <Grid item xs={0} sm={6} className="homepage__landing--logo">
            <HomepageLandingSvg />
        ...
        <Grid container className="homepage__features">
          ...
          <Grid item xs={0} sm={6} className="homepage__features__textgrid">
            <YesevaTitle text={homepageText[language].homepageFeaturesTitle} />
        ...
        <Grid container className="homepage__stats">
          <YesevaTitle text={homepageText[language].homepageStatsTitle} />
